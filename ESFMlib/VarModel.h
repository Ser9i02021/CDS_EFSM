...
public:
    ...
    // API de conveniência
    bool addVar(const QString& name, const QVariant& value);
    bool addEmptyRow(); // insere linha vazia p/ edição inline
...
private:
    static bool parseValue(const QString& s, QVariant& out); // tenta bool, depois int; senão string
    QVector<Entry> rows_;
};
